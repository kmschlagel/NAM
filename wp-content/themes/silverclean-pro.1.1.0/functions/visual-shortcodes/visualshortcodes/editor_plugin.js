    ...
    tinymce.create( 'tinymce.plugins.visualShortcodes', {
        ...
        _doScImage: function( co ){
            ...
            return co.replace( t.regex, function(a,b,c){
                ...
                return '<p class="helper-tag '+shortcode_class+'"><img src="'+t.shortcodes[b].image+'" id="vscImage'+(t.counter++)+'-'+b+'" class="mceItem jpbVisualShortcode ' + new_class + '" data-src="' + b + tinymce.DOM.encode(c) + '" /></p>';
            });
        },
