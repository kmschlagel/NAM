...
class JPB_Visual_Shortcodes {
	 ...
	 */
	function styles() {
		wp_enqueue_style('jpb_visualshortcodes', get_stylesheet_directory_uri() . '/functions/visual-shortcodes/buttons.css');
	}
	...
	function plugins($plugins) {
		$plugins['visualshortcodes'] = get_stylesheet_directory_uri() . '/functions/visual-shortcodes/visualshortcodes/editor_plugin.js';
		return $plugins;
	}
