 ...
 */
 ...
 /*
Jan 2013 Iceable Media Update Note: Altered line 61 & 72 for integration to the IceFit Framework
 */
...
class JPB_Visual_Shortcodes {
	 ...
	 */
	function styles() {
		wp_enqueue_style('jpb_visualshortcodes', get_template_directory_uri() . '/functions/icefit-mce3/visual-shortcodes/buttons.css');
	}
	...
	function plugins($plugins) {
		$plugins['visualshortcodes'] = get_template_directory_uri() . '/functions/icefit-mce3/visual-shortcodes/visualshortcodes/editor_plugin.js';
		return $plugins;
	}
