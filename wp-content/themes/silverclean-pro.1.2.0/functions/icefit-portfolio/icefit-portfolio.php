...
if ( $wp_version >= 3.8 ): // If WP 3.8 or later: use dashicons
	add_action( 'admin_head', 'portfolio_post_type_dashicon' );
else:
	add_action( 'admin_head', 'portfolio_post_type_icon' );
endif;

function portfolio_post_type_dashicon() {
	echo '<style>#adminmenu #menu-posts-icf_portfolio div.wp-menu-image:before{content:"\f322"}</style>';	
}
