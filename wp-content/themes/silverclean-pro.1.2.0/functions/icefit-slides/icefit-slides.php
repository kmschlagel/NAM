...
if ( $wp_version >= 3.8 ): // If WP 3.8 or later: use dashicons
	add_action( 'admin_head', 'slides_post_type_dashicon' );
else:
	add_action( 'admin_head', 'slides_post_type_icon' );
endif;

function slides_post_type_dashicon() {
	echo '<style>#adminmenu #menu-posts-icf_slides div.wp-menu-image:before{content:"\f128"}</style>';	
}
